...
import snorlax from "../../images/snorlax-gif.gif";
            ...
            <div className={styles.container} >
                ...
                <div  className={styles.content} >
                    <div className={styles.picture} >
                        ...
                        {pokeDetail[0].image ? <img className={styles.image} src={pokeDetail[0].image} alt="Icon pokemon"/> : <img src={snorlax} alt="Icon pokemon"/>}
                    ...
                    <div className={styles.info} >
                        ...
                        <div  className={styles.data} >
                            ...
                            <div className={styles.status} >
                                <p className={styles.H} >{pokeDetail[0]?.height}m</p>
