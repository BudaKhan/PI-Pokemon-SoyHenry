...
import snorlax2 from "../../images/snorlax-gif.gif";
        ...
        return (
            <div className={styles.content} >
                <div className={styles.picture} >
                    ...
                    {image?<Link to={`/home/${id}`}><img className={styles.pokei} src={image} alt="pokemon card"/></Link> : <Link to={`/home/${id}`}><img className={styles.pokei} src={snorlax2} alt="pokemon card"/></Link>}
